...
import { createStrongInterestsResult } from "./graphql/mutations";
const client = generateClient();
export default function StrongInterestsResultCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setRealistic(initialValues.realistic);
    setInvestigative(initialValues.investigative);
    setArtistic(initialValues.artistic);
    setSocial(initialValues.social);
    setEnterprising(initialValues.enterprising);
    setConventional(initialValues.conventional);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createStrongInterestsResult.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "StrongInterestsResultCreateForm")}
      {...rest}
    >
      <TextField
        label="Realistic"
