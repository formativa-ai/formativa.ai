...
export default function HeroGenerateText() {
    ...
    return (
        <div
            ...
            {/*<div className="">*/}
                {/* Gradients */}
                <div
                    className="absolute inset-x-20 top-0 bottom-2 bg-gradient-to-r from-transparent via-indigo-500 to-transparent h-[2px] w-3/4 blur-sm"/>
                {/*<div*/}
